...
class SHFTexts{
  ...
  static const String onBoardingSubTitle1 = "Chào mừng bạn đến với thiên đường mua sắm thời trang";
  static const String onBoardingSubTitle2 = "Để giao dịch liền mạch, hãy chọn đường dẫn thanh toán của bạn - Sự thuận tiện của bạn, ưu tiên của chúng tôi!";
  ...
  // static const String forgetPasswordSubTitle = "Don't worry sometimes people can forget to, enter your email and we will send you a password reset link.";
