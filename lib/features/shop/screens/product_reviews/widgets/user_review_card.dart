      ...
      children: [
        ...
        Row(
          children: [
            ...
            ///Review Stars
            SHFRatingBarIndicator(rating: productReview.rating),

            ///Review Date
            const SizedBox(width: 10.0),
            Text(SHFFormatter.formatDate(productReview.timestamp)),
          ],
        ),
        const SizedBox(height: 10.0),
        ...
        /// Review Reply
        Container(
          color: dark ? SHFColors.darkerGrey : SHFColors.grey,
          child: Padding(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(SHFFormatter.formatDate(productReview.companyTimestamp)),
                  ],
                ),
                const SizedBox(height: 10.0),
