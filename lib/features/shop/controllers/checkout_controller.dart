...
class CheckoutController extends GetxController {
  ...
  @override
  void onInit() {
    selectedPaymentMethod.value = PaymentMethodModel(name: PaymentMethods.momo.name, image: SHFImages.momo);
    super.onInit();
  }
      ...
      builder: (_) => SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const SHFSectionHeading(title: 'Chọn phương thức thanh toán', showActionButton: false),
              ...
              const SizedBox(height: SHFSizes.spaceBtwItems/2),
              SHFPaymentTile(paymentMethod: PaymentMethodModel(name: 'Credit Card', image: SHFImages.creditCard)),
              const SizedBox(height: SHFSizes.spaceBtwItems/2),
              const SizedBox(height: SHFSizes.spaceBtwSections),
            ],
          ),
